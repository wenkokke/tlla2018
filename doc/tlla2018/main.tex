...
\begin{definition}[Typing judgements]\label{def:cp}
  ...
  \begin{center} \cpInfPlus1  \cpInfPlus2 \end{center}\vspace*{0.5\baselineskip}
...
\begin{lemma}[Type preservation for \equiv]\label{lem:hcp-preservation-equiv}
...
\begin{theorem}[Subject reduction]\label{thm:hcp-preservation}

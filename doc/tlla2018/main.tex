...
\begin{definition}[Terms]\label{def:cp-terms}  Process terms are given by the following grammar:
  \[
    \begin{array}{rllrll}
      \tm{P}, \tm{Q}, \tm{R}
...
\begin{definition}[Reduction]\label{def:cp-reduction}
  Reductions are described by the smallest relation $\Longrightarrow$ on process terms closed under rules in \cref{fig:cp-reduction}.
...
\begin{figure}
%  Structural Rules.
  \begin{center}\cpInfAx     \cpInfCut  \end{center}\vspace*{-.5\baselineskip}
%  Logical Rules.
  \begin{center}\cpInfTens   \cpInfParr \cpInfOne    \end{center}\vspace*{-.5\baselineskip}
%  \begin{center}\end{center}\vspace*{-.5\baselineskip}
  \begin{center}\cpInfBot  \cpInfPlus1  \cpInfPlus2\end{center}\vspace*{-.5\baselineskip}
  \begin{center}\cpInfWith               
%  \end{center}\vspace*{-.5\baselineskip}\begin{center}
  \cpInfNil    \cpInfTop  \end{center} %\vspace*{-.5\baselineskip}
...
%  Logical Rules.
  \begin{center}\hccpInfBoundTens \hccpInfParr \hccpInfOne \end{center}\vspace*{-.5\baselineskip}
  \begin{center}\hccpInfBot \hccpInfPlus1 \hccpInfPlus2\end{center}\vspace*{-.5\baselineskip}
  \begin{center}\hccpInfWith \quad \hccpInfNil \quad \hccpInfTop  \end{center} %\vspace*{.5\baselineskip}
...
\begin{definition}[Typing judgements]\label{def:hcp}
  ...
  protocol $\Gamma_i$. Typing judgements are derived using rules in \cref{fig:hcp}---each rule has the side condition that $\tm{x} \not\in    \ty{\mathcal{G}}$.
\end{definition}

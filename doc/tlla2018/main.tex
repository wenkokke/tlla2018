...
constructs.
As expected, the term language of \hcp is a variant of \cp, where the term
constructs have been taken apart into \textpi-calculus primitives.
...
\begin{definition}[Typing judgements]\label{def:hcp}
  ...
  \begin{center}\hccpInfPlus1     \hccpInfPlus2\end{center}\vspace*{0.5\baselineskip}

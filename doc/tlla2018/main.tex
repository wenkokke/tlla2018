...
\begin{definition}[Typing judgements]\label{def:cp}
  ...
  Logical Rules.
  \begin{center} \cpInfTens   \cpInfParr  \end{center}\vspace*{-.5\baselineskip}
  \begin{center} \cpInfOne    \cpInfBot   \end{center}\vspace*{-.5\baselineskip}
  \begin{center} \cpInfPlus1  \cpInfPlus2 \end{center}\vspace*{-.5\baselineskip}
  \begin{center} \cpInfWith               \end{center}\vspace*{-.5\baselineskip}
  \begin{center} \cpInfNil    \cpInfTop   \end{center}\vspace*{-.5\baselineskip}
\end{definition}

...
\begin{enumerate*}[label={\alph*)}]
	...
	\item remove hypersequents from all logical rules as in \cite{montesi2018}.
\end{enumerate*}
For this revision, we opted for the second solution as it only required minimal changes to \cref{def:hcp} (all other definitions and theorems in the paper are unchanged).
